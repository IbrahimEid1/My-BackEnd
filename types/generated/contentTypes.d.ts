...
export interface ApiTrendingTwoTrendingTwo extends Struct.CollectionTypeSchema {
  collectionName: 'trending_twos';
  info: {
    displayName: 'TrendingTwo';
    pluralName: 'trending-twos';
    singularName: 'trending-two';
  };
  options: {
    draftAndPublish: true;
  };
